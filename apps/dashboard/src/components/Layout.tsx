  ...
  return (
    <>
      ...
      <nav className='bg-slate-50 border-b border-slate-200 px-8 py-4 flex gap-2 max-w-6xl mx-auto'>
        <Link
          to='/'
          className={`flex items-center gap-2 px-5 py-3 border border-slate-300 bg-white rounded-lg cursor-pointer font-medium text-sm transition-all duration-200 text-slate-600 tracking-tight no-underline min-w-[140px] justify-center ${
            location.pathname === '/' 
